...
impl LinuxTrayIcon {
    fn name(self) -> &'static str {
        match self {
            Self::Instant => "com.scrinx.desktop-tray-instant-symbolic",
            Self::Screenshot => "com.scrinx.desktop-tray-screenshot-symbolic",
            Self::Studio => "com.scrinx.desktop-tray-studio-symbolic",
            Self::Stop => "com.scrinx.desktop-tray-stop-symbolic",
        }
    }
