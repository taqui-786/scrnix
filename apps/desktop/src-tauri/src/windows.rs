...
impl CapWindowId {
    ...
    pub fn title(&self) -> String {
        match self {
            Self::Settings => "Scrinx Settings".to_string(),
            Self::WindowCaptureOccluder { .. } => "Scrinx Window Capture Occluder".to_string(),
            Self::CaptureArea => "Scrinx Capture Area".to_string(),
            Self::RecordingControls => "Scrinx Recording Controls".to_string(),
            Self::Editor { .. } => "Scrinx Studio".to_string(),
            Self::ScreenshotEditor { .. } => "Scrinx Screenshot Editor".to_string(),
            Self::ModeSelect => "Scrinx Mode Selection".to_string(),
            Self::Onboarding => "Welcome to Scrinx".to_string(),
            Self::Camera => "Scrinx Camera".to_string(),
            Self::RecordingsOverlay => "Scrinx Recordings".to_string(),
            Self::TargetSelectOverlay { .. } => "Scrinx Target Select".to_string(),
            Self::Teleprompter => "Scrinx Teleprompter".to_string(),
            _ => "Scrinx".to_string(),
        }
    }
